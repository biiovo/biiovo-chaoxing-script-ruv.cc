  ...
  return new Promise((resolve) => {
    ...
    let req = http.request(COURSELIST.URL, {
      ...
      if (res.statusCode === 302) {
        console.log('If your identity expires, the program will close. Please log in by filling in your user name and password manually! After manual login, the identity information is refreshed, and then you can continue to use local credentials!\n')
        process.exit(-1)
      }
      output = gzip;
